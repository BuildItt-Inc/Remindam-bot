# Contributing to Remindam Bot

Thank you for considering contributing to Remindam Bot! We welcome all kinds of contributions, including bug reports, feature requests, code improvements, and tests.

## Table of Contents

* [Contributing to Remindam Bot](#contributing-to-remindam-bot)
...
If you find a bug, please open an issue on [GitHub Issues](https://github.com/hngprojects/remindam-bot/issues) and include as much detail as possible. Provide steps to reproduce, expected and actual behavior, and any relevant logs.

### Suggesting Features

If you have an idea for a new feature, please open an issue on [GitHub Issues](https://github.com/hngprojects/remindam-bot/issues) and describe your proposal. Explain why the feature would be useful and how it should work.

### Code Contributions

> Please make sure to clone the original repository. This is where you will work in when contributing.
